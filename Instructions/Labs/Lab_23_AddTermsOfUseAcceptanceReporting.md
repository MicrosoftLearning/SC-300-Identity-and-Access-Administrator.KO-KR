...
ms.locfileid: "146741717"
---
# <a name="lab-23-add-terms-of-use-and-acceptance-reporting"></a>랩 23: 사용 약관 및 동의 보고 추가 
...
### <a name="exercise-1---set-up-a-term-of-use-and-test-them"></a>연습 1 - 사용 약관 설정 및 테스트

#### <a name="task-1---add-terms-of-use"></a>작업 1 - 사용 약관 추가
...
9. **사용 약관 문서 상자** 를 선택하고 완성된 사용 약관 PDF로 이동하여 선택합니다.
...
12. 최종 사용자가 액세스 중인 모든 디바이스에서 사용 약관에 동의하도록 요구하려면 **사용자의 모든 디바이스에서 동의하도록 함** 을 **끄기** 로 설정합니다. 해당 옵션을 사용하도록 설정하면 사용자가 추가 애플리케이션을 설치해야 할 수 있습니다.

    **경고** - 모든 디바이스에서 동의하려면 사용자가 액세스하기 전에 각 디바이스를 Azure AD에 등록해야 합니다. 이를 켜기로 설정하여 요구하는 것이 좋습니다. 그러나 보다 깨끗한 랩을 위해 끄기를 사용하고 있습니다.
...
15. **다시 동의가 필요하기 전 기간(일)** 설정을 사용하여 사용자가 사용 약관에 다시 동의해야 하기 전까지의 일 수를 지정합니다. 이를 통해 사용자는 자신의 일정을 따를 수 있습니다. 예를 들어 기간을 **30** 일로 설정하면 두 사용자에 대한 만료가 다음과 같은 방식으로 발생합니다.
    ...
    **참고** - 동의 만료 및 다시 동의가 필요하기 전 기간(일) 설정을 함께 사용할 수 있지만, 일반적으로 두 설정 중 하나만 사용합니다.
...
19. **할당** 아래에서 **사용자 또는 워크로드 ID** 를 선택합니다.

20. 포함 탭에서 **사용자 및 그룹** 확인란을 선택합니다.
...
#### <a name="task-2---log-in-as-adele"></a>작업 2 - Adele로 로그인
...
#### <a name="task-3---view-report-of-who-has-accepted-and-declined"></a>작업 3 - 사용 약관에 동의한 사용자와 동의하지 않은 사용자 관련 보고서 확인
...
#### <a name="task-5---how-users-can-review-their-terms-of-use"></a>작업 5 - 사용자가 사용 약관을 검토하는 방법
...
#### <a name="task-6---edit-terms-of-use-details"></a>작업 6 - 사용 약관 세부 정보 편집
...
2. Azure Active Directory를 열고 **ID 거버넌스** 를 선택합니다.
...
#### <a name="task-7---update-an-existing-terms-of-use-document"></a>작업 7 - 기존 사용 약관 문서 업데이트
