...
2. 왼쪽 탐색 메뉴에서 ID 거버넌스 ** 선택을**엽니다.

3. 메뉴의 권한 관리**에서 **사용** 약관을 선택합니다**.
...
10. 최종 사용자가 액세스 중인 모든 디바이스에서 사용 약관에 동의하도록 요구하려면 **사용자의 모든 디바이스에서 동의하도록 함**을 **끄기**로 설정합니다. 해당 옵션을 사용하도록 설정하면 사용자가 추가 애플리케이션을 설치해야 할 수 있습니다.
    ...
    **경고** - 모든 디바이스에서 동의하려면 액세스하기 전에 사용자가 각 디바이스를 Microsoft Entra ID에 등록해야 합니다. 이를 켜기로 설정하여 요구하는 것이 좋습니다. 그러나 보다 깨끗한 랩을 위해 끄기를 사용하고 있습니다.
...
17. **할당** 아래에서 **사용자 또는 워크로드 ID**를 선택합니다.

18. 포함 탭에서 **사용자 및 그룹** 확인란을 선택합니다.
...
20. **클라우드 앱 또는 작업**을 선택합니다.

21. **모든 클라우드 앱**을 선택합니다.

22. **액세스 제어**에서 **권한 부여**를 선택합니다.

23. 권한 부여 창에서 **테스트 사용 약관**을 선택한 다음 **선택**을 선택합니다.
...
2. 메뉴에서 Microsoft Entra ID 항목 및 선택 ID 거버넌스 **를 엽니다**.

3. 왼쪽 탐색 메뉴의 권한 관리**에서 **사용** 약관을 선택합니다**.
