...
**랩 팁** - 다음 몇 단계는 레거시 Azure 리소스 환경을 대상으로 작성된 것입니다.  화면 맨 위에서 이전 환경으로 전환할 수 있습니다. 또는 단계별 실행 없이 새 환경에서 연습을 완료할 수 있습니다.
...
6. **개요** 페이지에서 정보를 검토합니다.
   ...
   **랩 팁** - 랩 환경의 특성으로 인해 리소스가 표시되지 않습니다. 샘플이 필요하다면 그림을 참조하세요.
...
**참고** - 이 랩 환경에 적용되는 보안으로 인해 이 단계를 완료할 수 없습니다.  사용자 인터페이스의 단계를 검토하세요. 하지만 변경 내용을 적용할 수는 없습니다.  이에 대한 해결 방법을 마련하기 위해 적극적으로 노력하고 있습니다.
