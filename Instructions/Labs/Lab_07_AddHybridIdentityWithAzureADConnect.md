...
# 이 랩은 랩이 아닌 호스터 환경에서만 작동합니다. 개인 계정을 사용하여 시도해 보려면 정상적으로 작동합니다. 클래스 내에서 수행할 수 없습니다.





**참고** - 이 랩의 제목은 선택 사항입니다.  완료하는 데 최소 1시간 이상이 걸리며 랩 단계에서 자세히 설명해야 합니다.  시간이 허락하는 대로 자유롭게 컴퓨터로 작성해 주세요.  회사에서 이미 하이브리드 구성을 설정했거나 Microsoft Entra Connect를 사용할 계획이 없다면 이 랩을 건너뛰세요.
