...
ms.locfileid: "139258489"
---
# <a name="lab-08-configure-external-collaboration-settings"></a>랩 08: 외부 협업 설정 구성
...
5. `Home > Contoso Marketing >` **외부 ID** 를 클릭하여 이전 화면으로 돌아갑니다.
6. 왼쪽에서 **외부 협업 설정** 을 클릭합니다.
